...
type PackagedObject struct {
	...
	ResourceAttributes map[string]string `protobuf:"bytes,1,rep,name=resource_attributes,json=resourceAttributes,proto3" json:"resource_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	RecordAttributes   map[string]string `protobuf:"bytes,2,rep,name=record_attributes,json=recordAttributes,proto3" json:"record_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *PackagedObject) GetObject() isPackagedObject_Object {
	if m != nil {
		return m.Object
	}
	return nil
...
func (x *PackagedObject) GetPodSummary() *PodSummary {
	if x, ok := x.GetObject().(*PackagedObject_PodSummary); ok {
		return x.PodSummary
	}
	return nil
}
...
func (x *PackagedObject) GetSecretSummary() *SecretSummary {
	if x, ok := x.GetObject().(*PackagedObject_SecretSummary); ok {
...
func (x *PackagedObject) GetConfigMapSummary() *ConfigMapSummary {
	if x, ok := x.GetObject().(*PackagedObject_ConfigMapSummary); ok {
...
func (x *PackagedObject) GetAppsDeploymentSummary() *AppsDeploymentSummary {
	if x, ok := x.GetObject().(*PackagedObject_AppsDeploymentSummary); ok {
...
func (x *PackagedObject) GetAppsStatefulSetSummary() *AppsStatefulSetSummary {
	if x, ok := x.GetObject().(*PackagedObject_AppsStatefulSetSummary); ok {
...
func (x *PackagedObject) GetAppsDaemonSetSummary() *AppsDaemonSetSummary {
	if x, ok := x.GetObject().(*PackagedObject_AppsDaemonSetSummary); ok {
...
func (x *PackagedObject) GetAppsReplicaSetSummary() *AppsReplicaSetSummary {
	if x, ok := x.GetObject().(*PackagedObject_AppsReplicaSetSummary); ok {
...
var file_packaged_object_proto_rawDesc = []byte{
...
var (
	...
	file_packaged_object_proto_rawDescData = file_packaged_object_proto_rawDesc
)

func file_packaged_object_proto_rawDescGZIP() []byte {
	file_packaged_object_proto_rawDescOnce.Do(func() {
		file_packaged_object_proto_rawDescData = protoimpl.X.CompressGZIP(file_packaged_object_proto_rawDescData)
	})
...
func file_packaged_object_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_packaged_object_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_packaged_object_proto_rawDesc = nil
